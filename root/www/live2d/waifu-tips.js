...
function loadWidget(config) {
  ...
  function initWidget(config, apiPath) {
	...
	document.body.insertAdjacentHTML("beforeend", `<button id="waifu-toggle" type="button" title="看板娘"><i class="fa fa-address-card-o fas fa-heartbeat faa-pulse animated-hover"></i></button>`);
